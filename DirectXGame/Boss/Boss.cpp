...
void Boss::CreateBulletBound2Way(float theta, float speed, int hp) {
	// 弾を生成する
	BoundBullet* data = new BoundBullet;
	data->Init();
	data->transform_.translation_ = transform_.translation_;
...
void Boss::EnemyAttack_5() {
	// 2 Way を撃つ
	CreateBulletBound2Way(1.5f);
}
